...
public abstract class MyReferenceManager <G> implements Closeable {
    ...
    /** Remove a listener added with {@link #addListener(ReferenceManager.RefreshListener)}. */
